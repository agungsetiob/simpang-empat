                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <button type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><a href="<?php echo base_url();?>edit_galeri/<?php echo $row->id?>"><i class="material-icons">edit</i></a></button>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalCenterTitle">Galeri</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <i class="material-icons">close</i>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <img src="<?php echo base_url();?>upload-documents/<?php echo $row->gambar ?>" height="auto" width="100%" >
                                                </div>
...
<script type="text/javascript">
    function deletedata(id){
        Swal.fire({
            ...
            if (Delete) {
                $.ajax({
                    url: "<?php echo base_url('Galeri_Controller/hapus_galeri')?>",
                    type: "post",
                    data:{id:id},
                    success:function(){                          
                        window.location = "<?php echo base_url()?>daftar_galeri";
