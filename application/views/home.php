                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="project-details.html" class="nav-link">Project Details</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="councilor.html" class="nav-link">Our Councillors</a></li>
                                    <li class="nav-item"><a href="events.html" class="nav-link">Our Events</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner-text-area">
                        ...
                        <h1>We Developing Are Sustainable City</h1>
                        <p>Lorem ipsum dolor sit amet consectetuer adipiscing phasellus hendrerit lorem dolor sit amet magna nibh nec urna in nisi neque aliquet.</p>
    ...
    <div class="container">
        ...
        <div class="section-content">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="about-img">
                        <img class="a-img-1" src="assets/images/about/a4.jpg" alt="image">
                        <img class="a-img-2" src="assets/images/about/a5.jpg" alt="image">
                        <img class="a-img-3" src="assets/images/about/a6.jpg" alt="image">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="why-we-text-area about-text-area-2">
    ...
    <div class="container">
        ...
        <div class="section-content">
            <div class="feedback-slider-area-2 owl-carousel">
                <div class="feedback-card-2 mlr-15 mb-30">
...
<section class="footer">
    <div class="container">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-links footer-contact">
                        ...
                        <div class="footer-contact-card">
                            ...
                            <h5>Location: </h5>
                            <p><a href="https://goo.gl/maps/bc3qza49szqGNZt86" target="_blank">2976 sunrise road las vegas</a></p>
                        </div>
                        <div class="footer-contact-card">
                            <i class="fas fa-envelope"></i>
                            <h5>Email: </h5>
                            <p><a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#087b7d7878677a7c48656d6c7267266b6765"><span class="__cf_email__" data-cfemail="6615131616091412260b03021c094805090b">[email&#160;protected]</span></a></p>
                        </div>
                        <div class="footer-contact-card">
        ...
        <div class="copyright">
            <p>© <strong>Medzo</strong> All Rights Reserved By <a target="_blank" href="https://hibootstrap.com/">HiBootstrap</a></p>
        </div>
    </div>
</section>
